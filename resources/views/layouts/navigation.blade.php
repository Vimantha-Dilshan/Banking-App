<nav x-data="{ open: false }" class="bg-black/50 backdrop-blur-md border-b border-gray-800 text-white shadow-md">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                        class="text-gray-900 dark:text-gray-100 hover:text-green-500 dark:hover:text-green-400">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            </div>
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                ...
                                class="text-gray-900 dark:text-gray-100 hover:text-red-600 dark:hover:text-red-400">
                                {{ __('Log Out') }}
                            </x-dropdown-link>
                        </form>
                    </x-slot>
